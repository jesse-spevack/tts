...
# Used after soft-delete so a deleted account stops being charged. The user
# is already soft-deleted when this runs, so we look them up via
# User.unscoped. Stripe::APIConnectionError / Stripe::APIError propagate up
# to CancelsUserSubscriptionJob for retry; SubscriptionIdMismatchError is
